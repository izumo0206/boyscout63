...
const features = [
  {
    ...
    title: "考える力が育つ",
    description:
      "自然の中では思い通りにならないことばかり。「どうしよう？」と考えるきっかけがたくさんあります。グループ活動を通じて自分で考え、自分のことは自分でする力が身につきます。",
  },
  {
    number: "02",
    icon: HeartHandshake,
  ...
  },
  {
    ...
    title: "他の人の役に立つ喜び",
    description:
      "奉仕活動なども積極的に行い、自分のことをするだけでなく、他の人の役に立つ喜びを学びます。思いやりやリーダーシップ・社会性も身につきます。",
  },
]
      ...
      <div className="container mx-auto px-4">
        <div className="mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl">
            ボーイスカウトの目的は、青少年がその自発性を大切にしながら、グループでの活動や野外での体験を通じて、「自立したより良き社会人」として成長することを助けることにあります。
          </p>
          <p className="text-muted-foreground max-w-2xl mt-3">
            <a
              href="https://www.scout.or.jp/member/pr-movie2025"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary underline underline-offset-4"
            >
              https://www.scout.or.jp/member/pr-movie2025
            </a>
          </p>
        </div>
